...
export function AuthPage() {
  ...
  return (
    <div className="h-screen bg-neutral-card flex overflow-hidden">
      ...
      <main className="flex-1 h-full flex items-center justify-center px-4 sm:px-6 py-6 overflow-y-auto">
