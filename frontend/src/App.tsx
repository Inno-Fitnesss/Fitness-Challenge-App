...
import { shouldUseMobileExperience } from './mobile/mobileHost.ts';
...
export default function App() {
  const useMobileExperience = useMemo(() => shouldUseMobileExperience(), []);

  return (
    <BrowserRouter>
      <AuthProvider>
        {useMobileExperience ? <MobileApp /> : <DesktopRoutes />}
      </AuthProvider>
    </BrowserRouter>
  );
}
