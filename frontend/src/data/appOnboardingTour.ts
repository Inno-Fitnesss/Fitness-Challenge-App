...
export const APP_TOUR_STEPS: AppTourStep[] = [
  ...
  },
  {
    ...
    route: '/dashboard',
    title: 'Стрик — огонёк мотивации',
    description:
      'Считает дни подряд, когда вы выполняли план. Чем длиннее стрик, тем круче результат!',
    placement: 'left',
  },
  {
    id: 'today-plan',
  ...
  },
  {
    ...
    description:
      'Здесь создают и управляют челленджами. Сейчас перейдём туда — нажмите «Дальше».',
    placement: 'auto',
  },
  {
    id: 'create-challenge',
  ...
  },
  {
    ...
    description:
      'Объём упражнений за всё время, стрик, рекорд и график активности за 7 дней. Карандаш — редактирование профиля.',
    placement: 'auto',
  },
  {
    id: 'finish',
